  ...
  PHP_EACH fx_array AS int2 => fx_off BEGIN
    ...
    BEGIN
      ...
      PATCH_IF casting_type != CASTING_TYPE_instant BEGIN
        PATCH_PRINT ~HW245: %SOURCE_FILE% - opcode %opcode%, non-instant casting type %casting_type% for secondary spell %spell% in ability #%int%, effect #%int2%. This is likely a mistake, secondary spell can be interrupted after main spell is cast. Changing effect to instant cast.~
